        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            <div className="rounded-[1.75rem] bg-mint/55 p-6 sm:p-10">
              ...
              <p className="mt-2 text-sm text-ink/65">El pedido quedó pendiente. Todavía no está pagado ni descuenta stock; el próximo paso será integrar Mercado Pago.</p>
            ...
            <Link href="/" className="motion-button mt-6 inline-flex min-h-12 items-center rounded-xl bg-action px-6 py-3 font-black text-white">Volver al inicio</Link>
          </div>
        </Container>
      </main>
    </StorefrontShell>
